          ...
          try {
            ...
            if (tab === "invoice") {
              ...
              const invoiceFormData: InvoiceData = {
                ...
                billTo: {
                  name: parsedData.clientName || parsedData.billTo?.name || "",
                  phone: parsedData.clientPhone ?? parsedData.billTo?.phone ?? "",
                  area: parsedData.clientArea || parsedData.billTo?.area || "",
                  block: parsedData.clientBlock || parsedData.billTo?.block || "",
                  street: parsedData.clientStreet || parsedData.billTo?.street || "",
                  house: parsedData.clientHouse || parsedData.billTo?.house || "",
                  other: parsedData.clientOther || parsedData.billTo?.other || "",
                },
